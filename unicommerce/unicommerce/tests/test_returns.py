...
CANCELLATION_MODULE = "unicommerce.unicommerce.cancellation_and_returns"
SYNC_OLD_ORDERS_MODULE = "unicommerce.unicommerce.sync_old_orders"
...
class TestSyncOldReturns(TestCase):
	...
	def test_calls_both_sync_functions(self):
		from unicommerce.unicommerce.sync_old_orders import _sync_old_returns
