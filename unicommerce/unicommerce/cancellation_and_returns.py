	...
	for rto_return in rto_returns:
		...
		if not invoice:
			create_unicommerce_log(
				...
				method="unicommerce.unicommerce.cancellation_and_returns.sync_rto_returns",
			)
			continue
	...
	for customer_return in customer_returns:
		...
		try:
			...
			create_unicommerce_log(
				...
				method="unicommerce.unicommerce.cancellation_and_returns.sync_customer_initiated_returns",
			)
...
def create_cir_credit_note(so_data, return_data, client=None):
	...
	if not sales_order_name:
		create_unicommerce_log(
			...
			method="unicommerce.unicommerce.cancellation_and_returns.create_cir_credit_note",
		)
		return
