...
SYNC_METHODS = {
	"Items": "unicommerce.unicommerce.product.upload_new_items",
	"Orders": "unicommerce.unicommerce.order.sync_new_orders",
	"Inventory": "unicommerce.unicommerce.inventory.update_inventory_on_unicommerce",
}
