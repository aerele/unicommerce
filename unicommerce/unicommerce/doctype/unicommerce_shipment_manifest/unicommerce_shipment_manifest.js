...
frappe.ui.form.on("Unicommerce Shipment Manifest", {
  refresh(frm) {
    if (frm.doc.unicommerce_manifest_code) {
      ...
      frm.add_custom_button(
        ...
        function () {
          frappe.call({
            method:
              "unicommerce.unicommerce.utils.get_unicommerce_document_url",
            args: {
    ...
    frm.add_custom_button(__("Get Packages"), () => {
      ...
      erpnext.utils.map_current_doc({
        method:
          "unicommerce.unicommerce.doctype.unicommerce_shipment_manifest.unicommerce_shipment_manifest.get_shipping_package_list",
        ...
        get_query_filters: {
          ...
          unicommerce_shipping_provider: frm.doc.shipping_provider_code,
  ...
  scan_barcode: function (frm) {
    ...
    frappe
      .xcall(
        "unicommerce.unicommerce.doctype.unicommerce_shipment_manifest.unicommerce_shipment_manifest.search_packages",
        {
