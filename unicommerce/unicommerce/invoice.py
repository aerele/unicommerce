...
from unicommerce.unicommerce.order import get_taxes
...
def generate_unicommerce_invoices(sales_orders: Any, warehouse_allocation: Any = None):
	...
	if len(sales_orders) == 1:
		...
		log = create_unicommerce_log(
			method="unicommerce.unicommerce.invoice.bulk_generate_invoices",
...
def update_cancellation_status(so_data, so) -> bool:
	...
	# partial cancels
	from unicommerce.unicommerce.cancellation_and_returns import update_erpnext_order_items
