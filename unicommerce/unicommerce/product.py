...
from unicommerce.unicommerce.api_client import JsonDict, UnicommerceAPIClient
...
def _build_unicommerce_item(item_code: ItemCode) -> JsonDict:
	...
	item_json["description"] = frappe.utils.strip_html_tags(item.description) if item.description else None
